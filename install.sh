...
sudo apt update
sudo apt install -y python3 python3-pip python3-venv git bc || { echo "Failed to install dependencies. Exiting."; exit 1; }
...
read -p "Enter Modbus Server Host (default: 192.168.178.198): " modbus_host
